...
The PadBox is designed to create consistent padding based of off the spacing constants.
...
| Property (one of the following) | Type                                                                       | Default |
| ------------------------------- | -------------------------------------------------------------------------- | ------- |
| padding\*                       | spacing\*\*                                                                | -       |
| padding\* (array)               | Array of spacing options\*\*                                               | -       |
| padding\* (object)              | Object of with padding locations as keys and spacing\*\* options as values | -       |
