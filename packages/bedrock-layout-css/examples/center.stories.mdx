...
First you need to import the aproppriate stylesheet. The center is part of the main css bundle or you can import it in individually from the components directory.
