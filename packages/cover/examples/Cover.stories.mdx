...
The Cover is designed to cover a pre-defined area, 100vh by default, and vertically center its child. You can also conditionally render a top and bottom section as well.
