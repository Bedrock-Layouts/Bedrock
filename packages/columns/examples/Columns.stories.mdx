...
In the below code, the blue box is offsetStart by 1 and the green box has an offsetEnd of 2
...
The below Columns layout will switch to a Stack layout when it is less than `45rem`.
