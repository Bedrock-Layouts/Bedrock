...
The `minItemWidth` prop defines the minimum width of each of the children. The Grid will the optimize how many columns and rows are needed based on that value.
