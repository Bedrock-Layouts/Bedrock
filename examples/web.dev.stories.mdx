...
[I am open to suggestions.](/?path=/story/contributing--page)
...
Commonly referred to as a sticky footer, this layout is often used for both websites and apps. Uses the `<Stack>` component.
