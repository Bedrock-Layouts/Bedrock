...
export function Card() {
  return (
    <article>
      <img
        src="https://picsum.photos/seed/fruit/900/700"
        alt="A placeholder image of fruit from picsum.photos"
      />
      <h3>Fruit</h3>
      <p>
...
export function Card({ title }) {
  return (
    <Stack as="article" gap="size3">
      <Frame ratio={[16, 9]}>
        <img
          src={`https://picsum.photos/seed/${title}/900/700`}
          alt={`A placeholder image for ${title} from picsum.photos`}
        />
      </Frame>
