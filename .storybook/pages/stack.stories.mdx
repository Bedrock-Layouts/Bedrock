...
<Meta title="Getting Started/Your First Component" />

# Your First Component

One of the simplest and yet most common layout patterns found on the web is putting one element on top of another element with consistent space between the elements. This problem is precisely what the [**Stack**](http://localhost:9001/?path=/docs/components-stack) primitive solves.
...
<Center centerChildren>
  <img
    style={{ maxWidth: 800 }}
    src={newsletter}
    alt="Design mock of a subscribe to our newsletter component"
  />
</Center>
