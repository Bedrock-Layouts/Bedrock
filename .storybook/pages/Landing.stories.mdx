...
<Cover as={Center} maxWidth='90vw' minHeight='50vh' style={{ scrollSnapAlign: "start" }}>
<PadBox padding='size7' style={{background:'var(--gray-8)', borderRadius:'var(--radius-blob-1)'}}>
...
<Cover as={Center} maxWidth='90vw' minHeight='50vh' style={{ scrollSnapAlign: "start" }}>
<PadBox as={Center} maxWidth='90vw' padding='size9' style={{background:'var(--gray-8)', borderRadius:'var(--radius-blob-4)'}}>
