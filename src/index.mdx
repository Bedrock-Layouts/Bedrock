...
Bedrock Layout Primitives are built using a CSS-in-JS library called [`styled-component`](https://styled-components.com/). This allows all the components to be dropped into any app with no extra setup.
